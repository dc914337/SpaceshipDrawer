...
namespace SpaceshipDrawer
{
    ...
    class TestApp : D3DApp
    {
        ...
        Hull _spaceshipToShow;



        private bool _disposed;
        public TestApp(IntPtr hInstance, Hull spaceship)
        : base(hInstance)
    {
            _spaceshipToShow = spaceship;
            _vb = null;
            _ib = null;
            _fx = null;
            _tech = null;
        ...
        {
            var spaceShip = PolygonizeSpaceship(_spaceshipToShow);
